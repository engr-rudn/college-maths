...
> >- Coefficient of $$\left(x^2\): \(0 = A + B\), so \(A = -B\)$$.\
> >- Coefficient of $$\left(x\): \(1 = A + B - C\)$$.\
> >- Constant term: $$\left(0 = A - C\)$$.\
...
> >Using the substitution $$\left(u = x + \frac{1}{2}\), $$\left(du = dx\right)$$, the integral becomes:\
